    ...
    <div id="main">
      <div class="right">
        <div class="bx-sya pitch">
          <div class="hd">
            <h2 class="h">标题：<a href="<?php the_permalink() ?>" target="_blank">
              <?php the_title(); ?>
              </a></h2>
          </div>
          <div class="bd">
        ...
        <div class="bx-sya pitch">
          ...
          <div class="bd">
            <?php $posts = get_posts( "category_name=&tag=&numberposts=5" ); ?>
            <?php if( $posts ) : ?>
            <ul class="p-list-syb">
